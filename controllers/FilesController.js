...
class FilesController {
  /**
   * Handles file uploads, saving them to both the database and disk.
  ...
  /**
   * Fetches a file document using its ID.
   * @param {Object} req - Request object.
   * @param {Object} res - Response object.
   */
  ...
  /**
   * Retrieves all file documents for a user, filtered by parentId and supporting pagination.
   * @param {Object} req - Request object.
   * @param {Object} res - Response object.
   */
